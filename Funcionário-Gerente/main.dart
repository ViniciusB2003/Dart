...
void main() {
  ...
  while(tentativa < 4) {
    print("Qual Opção você prefere? 1 - Quer Aumento; 2 - Quer Reconhecimento; 3 - Quer Férias");
    String? op = stdin.readLineSync()!;
    int parsedOp = int.parse(op);
    bool aumento = primeiroGerente.mereceaumento(meuPrimeiroFuncionario.nomeDoInfeliz);
    ...
    if (parsedOp == 1 && aumento == false) {
      ...
      primeiroGerente.merecereconhecimento(meuPrimeiroFuncionario.nomeDoInfeliz!);
      tentativa += 1;
      print("Entrou na 2");
    } else if (parsedOp == 3) {
